...
const Landing = () => {
    ...
    return (
        <div className="w-full bg-primary-dark-gray">
                ...
                <div className="max-w-7xl w-7/8 h-full flex items-center justify-items-start">
                    <div className="relaive flex flex-col items-start gap-6 w-full lg:w-1/2">
                        <h1 className="relative text-3xl lg:text-6xl font-semibold text-primary-white">
                            ...
                            <Image src="/graduation.png" alt="Graduation" height={100} width={100} className="absolute -top-[28%] -left-[9%] -rotate-10" />
                        </h1>
                        ...
                        <div className="relative flex items-center gap-4">
                            ...
                            <Image src="/arrow.png" alt="Arrow" height={130} width={150} className="absolute -right-[80%] -bottom-[70%]" />
                        </div>
                    </div>
