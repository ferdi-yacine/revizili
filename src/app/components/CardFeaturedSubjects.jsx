    ...
    return (
        <div className='flex flex-1 flex-col items-center justify-between gap-4 min-w-[340px] w-full lg:w-1/3 py-8 px-6 border-[0.5] border-primary-light-gray shadow-sm'>
            <div className='flex flex-col items-center justify-center gap-4'>
                <div className="relative border-[0.5] border-solid border-primary-light-gray rounded-full h-40 w-40 p-2">
                    <Image src={src} alt='profile picture' fill={true} className='object-contain rounded-full' />
                </div>
